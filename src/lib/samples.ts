...
function cardioSample(): FamilyHistoryProfile {
  ...
  return touchProfile({
    ...
    personal: {
      ...
      tobaccoNicotineStatus: 'former',
      alcoholUse: 'weekly',
      substanceContext: '',
      accessBarriers: 'Prefers lower-cost prescriptions when there is a generic option.',
      healthWorries: 'Worried about early cardiovascular disease because of family pattern.',
...
function cancerSample(): FamilyHistoryProfile {
  ...
  return touchProfile({
    ...
    personal: {
      ...
      pregnancyContext: 'trying_to_conceive',
      tobaccoNicotineStatus: 'never',
      alcoholUse: 'occasional',
      substanceContext: '',
      accessBarriers: '',
      healthWorries: 'Worried about breast and ovarian cancer risk while planning pregnancy.',
...
function mixedSample(): FamilyHistoryProfile {
  ...
  return touchProfile({
    ...
    personal: {
      ...
      tobaccoNicotineStatus: 'never',
      alcoholUse: 'occasional',
      substanceContext: 'Occasional cannabis edible on weekends.',
      accessBarriers: 'Transportation is inconsistent for in-person appointments.',
      healthWorries: 'Wants to avoid repeating the same background details every visit.',
      medications: [],
...
function medCanonDemoSample(): FamilyHistoryProfile {
  ...
  return touchProfile({
    ...
    personal: {
      ...
      pregnancyContext: 'no_current_pregnancy_context',
      tobaccoNicotineStatus: 'never',
      alcoholUse: 'occasional',
      substanceContext: '',
      accessBarriers: 'Prescription cost matters if a refill is not covered.',
      healthWorries: 'Concerned about cardiovascular risk and breast-cancer screening because of family history.',
      medications: [
